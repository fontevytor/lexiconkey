...
import { ChevronLeft, Brain, Search, Plus, Trash2, Edit2, MessageSquare, HelpCircle, X, Save } from 'lucide-react';
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-700 font-medium">All words you've unlocked so far.</p>
          </div>
        </div>
